...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "35 years of mastery. The hands and heritage behind House of Kalaa." },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-[1400px] px-6 pt-16 md:px-10">
        <p className="text-[11px] font-semibold tracking-[0.24em] text-navy">INDUSTRY LEADERS FOR A REASON!</p>
        <h1 className="mt-3 text-4xl font-semibold tracking-tight md:text-5xl">35 years of mastery.</h1>
        ...
        <img src={workshop} alt="House of Kalaa workshop" className="mt-10 aspect-[16/9] w-full object-cover" loading="lazy" />
        ...
        <div className="mt-10 max-w-2xl space-y-4 text-sm leading-relaxed text-foreground/80">
          ...
          <p>
            A 4,000 sq ft space where the most articulate interior design solutions sit alongside pieces made in our
            own factory. Where you can see, and experience what considered living actually looks like.
          </p>
        ...
        <p className="text-[11px] font-semibold tracking-[0.24em] text-gold">WHAT WE BELIEVE</p>
        ...
        <Link to="/contact" className="mt-6 inline-block bg-navy px-6 py-3 text-[11px] font-semibold tracking-[0.16em] text-white hover:bg-navy/90">
      ...
      <section className="mt-10 space-y-1">
        {team.map((m, i) => (
          <div key={i} className="bg-navy text-white">
            <div className={`mx-auto grid max-w-[1400px] items-center gap-8 px-6 py-14 md:grid-cols-2 md:px-10 ${m.reverse ? "md:[&>*:first-child]:order-2" : ""}`}>
              <div>
                <h3 className="text-2xl font-semibold">{m.name}</h3>
                <p className="mt-1 text-[11px] font-semibold tracking-[0.2em] text-white/70">{m.role}</p>
              ...
              <div className={m.reverse ? "md:justify-self-start" : "md:justify-self-end"}>
                <img src={m.image} alt={m.name} className="aspect-[4/5] w-full max-w-[320px] object-cover grayscale" loading="lazy" />
              </div>
            </div>
          </div>
        ))}
      ...
      <section className="py-20 text-center">
        <p className="text-[11px] font-semibold tracking-[0.24em] text-gold">EXPERIENCE THE LEGACY</p>
        <h2 className="mt-3 text-3xl font-semibold md:text-4xl">From our workshop, to your home.</h2>
      </section>
