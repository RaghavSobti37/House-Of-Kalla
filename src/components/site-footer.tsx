      ...
      <div className="mx-auto grid max-w-[1400px] gap-8 px-6 py-16 md:grid-cols-2 md:px-10">
        <div>
          <div className="inline-flex flex-col items-center text-center">
            <img src={logo} alt="House of Kalaa" className="h-22 transform translate-y-12 w-auto brightness-0 invert" />
            <p className="mt-3 text-[12px] tracking-[0.10em] translate-y-12 text-white/60">
